...
import img from '../../../public/assets/EdTech Platform Image.svg';
...
const page = () => {
    ...
    const tabContent = [
        {
            title: "Why Choose Haelsoft’s JavaScript Course?",
            content: {
                heading: "Why Choose Haelsoft’s JavaScript Course?",
                paragraphs: [
                    "Hands-On Learning: Build real-world projects to apply your skills.",
                    "Expert Mentorship: Learn from experienced web developers and industry leaders.",
                    "Flexible Options: Self-paced online modules or live, interactive classes to fit your schedule.",
                    "Beginner to Advanced: Progress from basic concepts to advanced JavaScript techniques seamlessly.",
        ...
        },
        {
            ...
            content: {
                ...
                paragraphs: [
                    ...
                    "Designers interested in coding interactive features.",
        ...
        },
        {
            ...
            content: {
                ...
                paragraphs: [
                    "JavaScript Basics: Master variables, data types, operators, and control structures.",
                    "DOM Manipulation: Learn how to create interactive web pages by controlling HTML and CSS dynamically.",
                    "Event Handling: Understand how to manage user interactions like clicks, input, and animations.",
                    "APIs & Asynchronous JavaScript: Work with APIs, AJAX, and modern tools like Fetch and Promises.",
                    "ES6+ Features: Explore the latest JavaScript features, including arrow functions, modules, and classes.",
                    "Frameworks & Libraries: Get introduced to popular JavaScript tools like React and Vue.js."
                ]
            }
        },
        {
  ...
  return (
    <main>
            ...
            <div className='flex flex-col lg:flex-row justify-between items-center max-w-[1250px] mx-auto gap-20'>
                <div className='flex flex-col justify-center items-start gap-10'>
                    <div className='flex flex-col justify-center items-start gap-8'>
                        <h1 className='text-white font-bold text-[2.75rem] leading-[55px]'>Learn Javascript</h1>
                    ...
                    <p className='text-white w-full xl:w-[578px] text-[1rem] font-normal leading-[30px]'>
                        JavaScript is the backbone of modern web development, powering everything from interactive websites to complex web applications. Whether you're a beginner or an experienced developer looking to level up, Haelsoft EdTech Platform&apos;s Learn JavaScript course will give you the skills to build dynamic and responsive web solutions that stand out in today&apos;s digital world.
                    </p>
                ...
                <div className='py-[100px] flex flex-col justify-center items-start gap-20 2xl:gap-[150px] max-w-[1250px] mx-auto px-6'>
                    ...
                    <div className='relative w-[full xl:w-[763px] min-h-[871px] bg-white shadow-lg z-20 p-[26px]'>
                        ...
                        <div className='relative z-10 flex flex-col justify-center items-start gap-20'>
                            <div className='flex flex-col justify-center items-start gap-10'>
                                <div className='flex flex-col justify-center items-start gap-4'>
                                    <h1 className='text-white font-semibold text-[1.5rem] leading-[29.26px]'>Unlock the Power of Web Development with JavaScript</h1>
                                    <div className='bg-[#F1C118] rounded w-[56px] h-[4px]'></div>
                                </div>
                            ...
                            <p className='text-white text-[1rem] font-normal leading-[30px] w-full lg:w-[424px]'>
                                Start your journey as a web developer today with Haelsoft EdTech Platform. Our Learn JavaScript course is your gateway to creating beautiful, functional, and innovative web applications.
                            </p>
                        </div>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                <div className='flex flex-col justify-center items-start gap-6 w-full lg:w-[274px]'>
                                    ...
                                    <p className='text-[#201A18] font-normal text-[1rem] leading-[30px]'>
                                        Master variables, data types, operators, and control structures.
                                    </p>
                                </div>
                                <div className='flex flex-col justify-center items-start gap-6 w-full lg:w-[274px]'>
                                    <h2 className='text-[#201A18] text-[.875rem] leading-[30px] font-semibold'>
                                    ...
                                    <p className='text-[#201A18] font-normal text-[1rem] leading-[30px]'>
                                        Learn how to create interactive web pages by controlling HTML and CSS dynamically.
                                    </p>
                                </div>
                                <div className='flex flex-col justify-center items-start gap-6 w-full lg:w-[274px]'>
                                    <h2 className='text-[#201A18] text-[.875rem] leading-[30px] font-semibold'>
                                    ...
                                    <p className='text-[#201A18] font-normal text-[1rem] leading-[30px]'>
                                        Understand how to manage user interactions like clicks, input, and animations.
                                    </p>
                                </div>
                                <div className='flex flex-col justify-center items-start gap-6 w-full lg:w-[274px]'>
                                    <h2 className='text-[#201A18] text-[.875rem] leading-[30px] font-semibold'>
                                    ...
                                    <p className='text-[#201A18] font-normal text-[1rem] leading-[30px]'>
                                        Work with APIs, AJAX, and modern tools like Fetch and Promises.
                                    </p>
                                </div>
                                <div className='flex flex-col justify-center items-start gap-6 w-full lg:w-[274px]'>
                                    <h2 className='text-[#201A18] text-[.875rem] leading-[30px] font-semibold'>
                                    ...
                                    <p className='text-[#201A18] font-normal text-[1rem] leading-[30px]'>
                                        Explore the latest JavaScript features, including arrow functions, modules, and classes.
                                    </p>
                                </div>
                                <div className='flex flex-col justify-center items-start gap-6 w-full lg:w-[274px]'>
                                    <h2 className='text-[#201A18] text-[.875rem] leading-[30px] font-semibold'>
                                    ...
                                    <p className='text-[#201A18] font-normal text-[1rem] leading-[30px]'>
                                        Get introduced to popular JavaScript tools like React and Vue.js.
                                    </p>
                                </div>
                            </div>
                        </div> 
        ...
        <section className='flex flex-col justify-center items-center gap-20 py-[100px]'>
            <h1 className='text-[#201A18] text-[1.75rem] leading-[34.13px] font-bold'>Leading Businesses Need JavaScript</h1>
        ...
        <section className='max-w-[1250px] mx-auto px-6 flex flex-col justify-center items-start gap-8'>
            <div className='flex flex-col justify-center items-start gap-4'>
                <h1 className='text-[#201A18] text-[1.75rem] leading-[34.13px] font-bold'>Why Learn JavaScript?</h1>
            ...
            <div className='w-full xl:w-[578px] flex flex-col justify-center items-start gap-10'>
                <div className='flex justify-between items-start gap-3'>
                    ...
                    <p className='text-[#201A18] leading-[30px] text-[1rem] font-normal'>
                        <span className='text-black font-bold'>In-Demand Skill:</span> JavaScript is one of the most popular and widely-used programming languages in the world.
                    </p>
                </div>
                <div className='flex justify-between items-start gap-3'>
                    <GoCheck className='text-main text-[1.5rem]' />
                    <p className='text-[#201A18] leading-[30px] text-[1rem] font-normal'>
                        <span className='text-black font-bold'>Versatility:</span> Use JavaScript for front-end, back-end, mobile app development, and more.
                    </p>
                </div>
                <div className='flex justify-between items-start gap-3'>
                    <GoCheck className='text-main text-[1.5rem]' />
                    <p className='text-[#201A18] leading-[30px] text-[1rem] font-normal'>
                        <span className='text-black font-bold'>Career Opportunities:</span> Gain access to high-paying jobs in web development, UI/UX design, and software engineering.
                    </p>
                </div>
                <div className='flex justify-between items-start gap-3'>
                    <GoCheck className='text-main text-[1.5rem]' />
                    <p className='text-[#201A18] leading-[30px] text-[1rem] font-normal'>
                        <span className='text-black font-bold'>Creativity & Innovation:</span> Bring your ideas to life with interactive and user-friendly applications.
                    </p>
                </div>
