  ...
  return (
    <>
        <div className="relative mb-[200px]">
            <Skeleton className="w-full h-[70vh] lg:h-[50vh] mb-8 border-b-[3px] border-b-white"/>
            <Skeleton className="w-[500px] rounded-3xl h-[600px] mb-8 border-b-[3px] border-b-white absolute top-8 right-[200px]"/>
        </div>
        <Skeleton className="max-w-[1550px] rounded-3xl mx-auto h-[60vh] mb-[50px] border-b-[3px] border-b-white"/>
        <Skeleton className="max-w-[1550px] rounded-3xl mx-auto h-[60vh] mb-[50px] border-b-[3px] border-b-white"/>
        <div className="max-w-[1250px] mx-auto py-[100px]">
            {
                [...Array(6)].map((_, index) => {
                    <div key={index} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-center place-items-center gap-8">
                        <Skeleton className="w-full h-full rounded-lg border-b-[3px] border-b-white"/>
                    </div>
                })
            }
        </div>
