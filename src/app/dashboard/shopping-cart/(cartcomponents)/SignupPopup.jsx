    ...
    <div className='w-full fixed z-50 h-screen top-0 left-0 bg-[#F0F0F0]/70 flex justify-center items-center py-[100px] px-[20px]'>
        <div className='bg-white rounded-lg w-full xl:w-[720px] lg:h-[800px] py-[30px] px-[50px] flex flex-col justify-center gap-10 items-start'>
            ...
            <form className='w-full flex flex-col gap-8' action="">
                <input placeholder='Full name' className='outline-none placeholder:text-grayTwo placeholder:text-base placeholder:font-medium font-medium placeholder:leading-6 leading-6 text-base w-full lg:w-[610px] py-[28px] px-[33px] border-2 gap-[10px] border-[#F0F0F0] rounded-lg lg:h-[80px] bg-[#F7F7F7]' type="text" name="" id="" />
                <input placeholder='Email' className='outline-none placeholder:text-grayTwo placeholder:text-base placeholder:font-medium font-medium placeholder:leading-6 leading-6 text-base w-full lg:w-[610px] py-[28px] px-[33px] border-2 gap-[10px] border-[#F0F0F0] rounded-lg lg:h-[80px] bg-[#F7F7F7]' type="text" name="" id="" />
                <input placeholder='Password' className='outline-none placeholder:text-grayTwo placeholder:text-base placeholder:font-medium font-medium placeholder:leading-6 leading-6 text-base w-full lg:w-[610px] py-[28px] px-[33px] border-2 gap-[10px] border-[#F0F0F0] rounded-lg lg:h-[80px] bg-[#F7F7F7]' type="text" name="" id="" />
            ...
            <div className='flex flex-col gap-6 mx-auto text-center'>
                <p className='text-grayTwo font-medium text-base leading-[46px]'>By signing up, you agree to our Terms of use and Privacy Policy </p>
