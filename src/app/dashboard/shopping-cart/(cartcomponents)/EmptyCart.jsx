...
const EmptyCart = () => {
  return (
    <div className='w-full lg:max-w-[1200px] mx-auto flex flex-col justify-start items-start gap-4'>
        <p className='text-[.875rem] leading-[21px] font-medium'>0 Courses</p>
        <div className='border-4 border-[#F0F0F0] w-full lg:w-[1070px] h-[628px] flex flex-col gap-6 justify-center items-center'>
