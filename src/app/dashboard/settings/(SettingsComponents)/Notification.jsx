        ...
        <div className='px-[15px] lg:px-[30px] flex flex-col justify-start items-start gap-[6em] w-full'>
            <div className='w-full flex flex-col justify-start items-start gap-10'>
                <div className='flex flex-col md:flex-row w-full justify-between items-center gap-3'>
                    <Label htmlFor="airplane-mode" className='text-grayTwo text-[1.25rem] font-medium leading-[46px]'>Promotional Emails</Label>
                    <Switch className='data-[state=checked]:bg-main' id="airplane-mode" />
                </div>
                <div className='flex flex-col md:flex-row w-full justify-between items-center gap-3'>
                    <Label htmlFor="airplane-mode" className='text-grayTwo text-[1.25rem] font-medium leading-[46px]'>Announcements</Label>
                    <Switch className='data-[state=checked]:bg-main' id="airplane-mode" />
                </div>
                <div className='flex flex-col md:flex-row w-full justify-between items-center gap-3'>
                    <Label htmlFor="airplane-mode" className='text-grayTwo text-[1.25rem] font-medium leading-[46px]'>Payment reminders</Label>
                    <Switch className='data-[state=checked]:bg-main' id="airplane-mode" />
                </div>
                <div className='flex flex-col md:flex-row w-full justify-between items-center gap-3'>
                    <Label htmlFor="airplane-mode" className='text-grayTwo text-[1.25rem] font-medium leading-[46px]'>Learning progress</Label>
                    <Switch className='data-[state=checked]:bg-main' id="airplane-mode" />
                </div>
            </div>
            <button
