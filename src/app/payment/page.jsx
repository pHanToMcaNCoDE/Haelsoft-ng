    ...
    <div className="mb-32">
      ...
      <div className="max-w-[1100px] mx-auto space-y-8 mt-20 mb-32">
        <div className="px-4 w-full my-4">
          ...
          <p className="pb-4 border-b text-sm border-b-[#FF8C53] text-[#655D59] w-[60%]">
            {cartItemsCount} Courses in cart
          </p>
        </div>
        <div className="flex px-4 lg:gap-x-8 lg:px-0 lg:flex-row flex-col-reverse items-start w-full justify-between text-[#655D59]">
          ...
          <div className="flex flex-col pt-8 gap-y-8 w-full md:w-fit">
            <div className="flex flex-col text-[16px] font-semibold">
              <p className="text-[#655D59]">Total</p>
              <p className="text-[#655D59]">
