...
const SignupCarousel = () => {
    const items = [
        <section key="1" className="relative signupOne item w-full min-h-screen flex gap-4 text-white">
            ...
            <div className="py-3 px-8 flex flex-col justify-center text-left items-start gap-2 z-10">
                <h1 className="text-[1.5rem] md:text-[3rem] 2xl:text-[3.5rem] font-semibold leading-[40px]">Join Our Learning <br className="hidden lg:flex"></br>Community</h1>
        ...
        <section key="2" className="relative signupTwo item w-full h-screen flex gap-4 text-white">
            <div className='bg-[#000]/40 w-full h-screen absolute top-0 left-0 z-[5px]'></div>
            <div className="py-3 px-8 flex flex-col justify-center text-left items-start gap-2 z-10">
                <h1 className="text-[1.5rem] md:text-[3rem] 2xl:text-[3.5rem] font-semibold leading-[40px]">Start Building Your <br className="hidden lg:flex"></br>Future</h1>
        ...
        <section key="3" className="relative signupThree item w-full h-screen flex gap-4 text-white">
            <div className='bg-[#000]/40 w-full h-screen absolute top-0 left-0 z-[5px]'></div>
            <div className="py-3 px-8 flex flex-col justify-center text-left items-start gap-2 z-10">
                <h1 className="text-[1.5rem] md:text-[3rem] 2xl:text-[3.5rem] font-semibold leading-[40px]">Access Exclusive <br className="hidden lg:flex"></br>Content</h1>
