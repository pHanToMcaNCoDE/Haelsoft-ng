  ...
  return (
    <section className='pb-[40px] pt-[100px] lg:pb-0 relative min-h-screen 2xl:h-[138vh] overflow-hidden'>
        ...
        <div className='flex justify-start items-center max-w-[1000px] mx-auto mt-[4em] md:mt-[7em] pb-5 px-10 xl:px-0'>
          <CourseCards/>
          <Image width={1200} height={1335} src={online} className='hidden md:flex w-full xl:w-[1200px] xl:h-[1300px] 2xl:h-[1335px] object-cover z-10 absolute right-[-5%]' alt="Workers" />
        </div>
    </section>
  )
}
