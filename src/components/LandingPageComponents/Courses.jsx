  ...
  return (
    <section className='pb-[40px] pt-[100px] lg:pb-0 relative lg:min-h-screen 2xl:h-[138vh] overflow-hidden'>
        <div className='flex flex-col justify-center items-center gap-6 px-5 lg:px-8 text-center mb-10'>
          ...
          <p className='w-full relative z-10 lg:w-[639px] text-center text-base text-grayTwo mb-8'>
        ...
        <div className='flex justify-start items-center max-w-[1000px] mx-auto mt-[10em] xl:mt-[7em] pb-5 px-10 xl:px-0'>
          <CourseCards/>
