...
const BenefitsOnline = () => {
  return (
    <section className='overflow-hidden min-h-screen xl:h-[1536px] w-full pb-[100px] relative pt-[300px] bg-main'>
        ...
        <div className='max-w-[1200px] 2xl:max-w-[1530px] mx-auto min-h-screen pt-[111px] flex flex-col justify-center items-start gap-y-[150px]'>
          <div className='bg-white p-[28px] w-full lg:w-[520px] rounded-[5px] h-[600px] relative z-10 flex flex-col justify-center items-center gap-10'>
            ...
            <div>
              <p className='text-base text-[#655D59] text-center font-normal'>
