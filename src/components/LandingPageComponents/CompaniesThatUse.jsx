...
const CompaniesThatUse = () => {
  return (
    <section className='flex flex-col justify-center items-center gap-20 py-[100px]'>
        <h1 className='text-[#201A18] text-[1.75rem] leading-[34.13px] font-bold'>Leading Businesses Need Python Skills</h1>
...
export default CompaniesThatUse