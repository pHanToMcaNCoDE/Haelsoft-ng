      ...
      <div className="hero-content px-5 lg:px-8 w-full gap-[2em]">
        <div className='max-w-[1200px] 2xl:max-w-[1530px] mx-auto'>
            <div className='flex flex-col gap-[6em] py-[100px]'>
                ...
                <Link href={`/signup`} className="py-[15px] px-[24px] border border-[#F36400] bg-[#F36400] text-white font-normal text-[1.125rem] leading-10 h-[48px] w-[181px] flex justify-center items-center gap-2 rounded">Get Started</Link>
            </div>
        </div>
      </div>
