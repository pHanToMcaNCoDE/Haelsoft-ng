...
const TestimonialHero = () => {
  return (
    <section className='w-full relative h-[422px] lg:h-[552px] testimonial-hero overflow-hidden pb-[100px] pt-[100px] lg:pt-[200px] px-[16px]'>
      <div className='h-[422px] lg:h-[552px] absolute bg-main/[30%] top-0 w-full left-0'></div>

      <div className='flex flex-col justify-center items-start gap-3 max-w-[1350px] mx-auto'>
        <h2 className='text-yellow-400 font-normal text-[.875rem]'>Testimonials</h2>
